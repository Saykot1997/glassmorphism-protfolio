                ...
                </div>
                {
                    showVideo ?
                        ...
                        <div className=' w-full rounded-xl overflow-hidden shadow-sm shadow-white' >
                            <iframe className=' w-full h-[200p] sm:h-[300px] md:h-[400px] lg:h-[560px]' src="https://www.youtube.com/embed/IyG8hTA5zcg" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                        </div>
                        :
