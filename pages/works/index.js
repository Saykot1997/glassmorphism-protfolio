...
import photo14 from "../../images/work14.png"
                ...
                isMenuOpen ?
                    ...
                    <div className=' z-30 min-h-[95vh] sm:min-h-[85vh] w-[92%] sm:w-[85%] px-5 sm:px-10 py-5 bg-white bg-opacity-20 rounded-2xl backdrop-blur-sm'>
                        ...
                        <div className=' w-full flex justify-end'>
                            <div onClick={menubarToggle} className=' z-30 cursor-pointer h-10 sm:h-14 w-10 sm:w-14 rounded-full bg-white bg-opacity-30 flex justify-center items-center hover:bg-pink-500 hover:text-white transition-all duration-300 ease-in-out group'>
                        ...
                        <div className=' w-full'>
                            ...
                            <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-5'>
                                ...
                                <div className=' w-full'>
                                    ...
                                    <p className=' text-xl my-4 px-2'>Excel Automation</p>
                                    <Link href="/works/excelAutomation">
                                        <a>
                                            <button className='commonbutton'>View Project</button>
                                        </a>
