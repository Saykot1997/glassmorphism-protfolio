...
import photo2 from "../../images/work12.png";
import Image from 'next/image'
import { useRouter } from 'next/router'
import Link from 'next/link'


export default function FlipkartAdmin() {
        ...
        <div className=" relative min-h-screen w-full py-5 sm:py-16 flex justify-center items-center bg-gradient-to-br from-indigo-400 via-purple-300 to-pink-300">
            ...
            <div className='min-h-[95vh] sm:min-h-[85vh] w-[92%] sm:w-[70%] px-5 sm:px-10 py-3 sm:p-5 bg-white bg-opacity-20 rounded-2xl backdrop-blur-sm p-10 border-2 border-white border-opacity-20 relative'>
                ...
                <div className=' mt-3 sm:mt-5'>
                    <Link href="https://saykotflipkartadmin.herokuapp.com/">
                    ...
                    <Link href="https://hub.docker.com/repository/docker/saykot/flipkart-clone-admin">
                        <a target="_blank" rel="noopener noreferrer" >
                ...
                <h3 className=' text-lg sm:text-2xl my-3 sm:my-5 font-semibold'>E-commerce Website Addmin Dashboard</h3>

                <p className=' text-gray-700 text-sm sm:text-base'>This is a flipkart clone e-commerce website admin dashboard.The purpose of making this website to enhance the personal skill of web developement and programing.
                </p>

                {/* Features */}
                <h3 className=' text-lg sm:text-xl font-semibold text-gray-800 mt-3'>Features :</h3>
                <div>
                    <p className='featuresItem'><span className=' mr-3 text-lg font-semibold'>*</span> Create, Read, Update, Delete Catagories </p>
                    <p className='featuresItem'><span className=' mr-3 text-lg font-semibold'>*</span> Create, Read, Update, Delete Products </p>
                    <p className='featuresItem'><span className=' mr-3 text-lg font-semibold'>*</span> Create, Read, Update, Delete Pages </p>
                    <p className='featuresItem'><span className=' mr-3 text-lg font-semibold'>*</span> Control of order delevery status </p>
                </div>
                {/* Features */}
                ...
                <div className='my-5 '>
                    ...
                    <div className='mb-5'>
                        ...
                        <div className='flex flex-wrap'>
                            ...
                            <span className='skilitem'>Validator.js</span>
