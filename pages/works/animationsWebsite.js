...
import photo2 from "../../images/work9.png";
        ...
        <div className=" relative min-h-screen w-full py-5 sm:py-16 flex justify-center items-center bg-gradient-to-br from-indigo-400 via-purple-300 to-pink-300">
            ...
            <div className='min-h-[95vh] sm:min-h-[85vh] w-[92%] sm:w-[70%] px-5 sm:px-10 py-3 sm:p-5 bg-white bg-opacity-20 rounded-2xl backdrop-blur-sm p-10 border-2 border-white border-opacity-20 relative'>
                ...
                <div className=' mt-3 sm:mt-5'>
                    <Link href="https://saykot1997.github.io/animation-website/">
                        <a target="_blank" rel="noopener noreferrer" >
                            <button className='commonbutton mt-3 lg:mt-0'>Live Demo</button>
                        </a>
                    </Link>
                    <Link href="https://github.com/Saykot1997/animation-website">
                        <a target="_blank" rel="noopener noreferrer" >
                ...
                <h3 className=' text-lg sm:text-2xl my-3 sm:my-5 font-semibold'>Glassmorphism Animation Website</h3>

                <p className=' text-gray-700 text-sm sm:text-base'>This is a static html Glassmorphism animation website. The purpose of making this website to enhance the personal skill of web developement and programing.
                </p>
