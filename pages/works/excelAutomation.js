...
import photo2 from "../../images/work14.png";
        ...
        <div className=" relative min-h-screen w-full py-5 sm:py-16 flex justify-center items-center bg-gradient-to-br from-indigo-400 via-purple-300 to-pink-300">
            ...
            <div className='min-h-[95vh] sm:min-h-[85vh] w-[92%] sm:w-[70%] px-5 sm:px-10 py-3 sm:p-5 bg-white bg-opacity-20 rounded-2xl backdrop-blur-sm p-10 border-2 border-white border-opacity-20 relative'>
                ...
                <div className=' mt-3 sm:mt-5'>
                    <Link href="https://coral-app-3c24l.ondigitalocean.app/">
                ...
                <h3 className=' text-lg sm:text-2xl my-3 sm:my-5 font-semibold'>Excel Data Automation</h3>

                <p className=' text-gray-700 text-sm sm:text-base'>This is an official project for in house work. This {`project's`} main goal is to automate specific excel data entry and reduce man power or time.
                </p>
                ...
                <div className='my-5 '>
                    ...
                    <div>
                        <p className='featuresItem'><span className=' mr-3 text-lg font-semibold'>*</span>Upload excel file and modify tergeted fields</p>
                        <p className='featuresItem'><span className=' mr-3 text-lg font-semibold'>*</span>Download back the info in excel file. </p>
                    </div>
                    {/* Features */}
